...
# import math
# import os
import gc  # Import thư viện Garbage Collection
...
def find_similar_images():
    try:    
        ...
        # Giải phóng bộ nhớ
        del model  # Xóa biến model
        del vectors  # Xóa biến vectors
        del paths  # Xóa biến paths
        gc.collect()  # Gọi Garbage Collection để giải phóng bộ nhớ

        # # Trả về kết quả dưới dạng JSON
        return jsonify(result)
    
    except Exception as e:
        return jsonify(f'Error during retraining: {str(e)}')
